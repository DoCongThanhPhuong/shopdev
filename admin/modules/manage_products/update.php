<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $sql_fix = "UPDATE tblproduct SET category_id =  '$category_id', product_name = '" . $product_name . "', product_description = '" . $product_description . "', product_quantity = '$product_quantity', 
