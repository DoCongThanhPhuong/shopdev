  ...
  <div class="card bg-light mt-5">
    <article class="card-body mx-auto">
      ...
      <form action="" method="POST" >
        ...
        <p class="text-center">
          <a class="btn btn-outline-primary" href="index.php?navigate=change_password">Đổi mật khẩu</a>
        </p>
        <p class="text-center">
          <a class="btn btn-outline-primary" href="index.php?navigate=change_profile">Cập nhật thông tin</a>
        </p>
      </form>
    </article>
  </div>
